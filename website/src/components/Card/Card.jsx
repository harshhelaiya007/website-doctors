...
function Card() {
    ...
    const handleEmail = (e) => {
        ...
        if (!inputValue == '' && emailRegx.test(inputValue)) {
            ...
            showRequired(e.target, 'Email is Required.', 'Please Enter Valid Email Address.');
        }
    }

    const handleRegion = (e) => {
        e.target.value = (e.target.value.replace(/[^a-z\s]/ig, ''));
    ...
    const handleNumber = (e) => {
        ...
        if (!inputValue == '' && docNumberRegx.test(inputValue)) {
            ...
            showError(e.target, 'Docots Number is Required', 'Please Enter Valid Docots Number.');
        }
    }
            ...
            <div className="d-flex main-wrapper">
                <div className="left-side-wrapper">
                    <div className="d-flex form-flex-wrapper">
                        <Input inputId={'inputDoctorName'} type="text" name="fullName" labelText={'Doctor Name'} changeEvent={handleName} />
                        <Input inputId={'inputEmail'} type="text" name="email" labelClassName={'email-label'} labelText={'Email'} changeEvent={handleEmail} />
                    </div>
                    <div className="d-flex form-flex-wrapper">
                        <Input inputId={'inputRegion'} type="text" name="region" labelText={'Region'} changeEvent={handleRegion} />
                        <Input inputId={'inputHQ'} type="text" name="hq" labelClassName={'email-label'} labelText={'HQ'} changeEvent={handleHq} />
                    </div>
                    <div className="d-flex form-flex-wrapper">
                        <Input inputId={'inputFSOName'} type="text" name="fsoName" labelText={'FSO Name'} changeEvent={handleName} />
                        <Input inputId={'inputDoctorNumber'} type="text" name="doctorNumber" labelClassName={'email-label'} labelText={'Doctors Number'} changeEvent={handleNumber} />
                    </div>
